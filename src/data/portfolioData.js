  ...
  awards: [
    {
      ...
      titleHtml: "Authored <span class='relative inline-block px-1 mx-0.5 transition-colors duration-300 z-10 group-hover:text-neutral-950 dark:group-hover:text-neutral-50'><span class='absolute inset-x-0 bottom-0 h-[3px] bg-indigo-400/60 transition-all duration-300 ease-out group-hover:h-full -z-10 rounded-sm opacity-70 group-hover:opacity-100'></span><span class='relative font-medium'>research paper</span></span> on security implications of integrating <span class='relative inline-block px-1 mx-0.5 transition-colors duration-300 z-10 group-hover:text-neutral-950 dark:group-hover:text-neutral-50'><span class='absolute inset-x-0 bottom-0 h-[3px] bg-sky-400/60 transition-all duration-300 ease-out group-hover:h-full -z-10 rounded-sm opacity-70 group-hover:opacity-100'></span><span class='relative font-medium'>Windows Copilot</span></span> into OS"
    },
    {
      title: "Core member and graphic designer in Cisco iGen community and Encrypt Edge",
      titleHtml: "Core member and <span class='relative inline-block px-1 mx-0.5 transition-colors duration-300 z-10 group-hover:text-neutral-950 dark:group-hover:text-neutral-50'><span class='absolute inset-x-0 bottom-0 h-[3px] bg-pink-400/60 transition-all duration-300 ease-out group-hover:h-full -z-10 rounded-sm opacity-70 group-hover:opacity-100'></span><span class='relative font-medium'>graphic designer</span></span> in <span class='relative inline-block px-1 mx-0.5 transition-colors duration-300 z-10 group-hover:text-neutral-950 dark:group-hover:text-neutral-50'><span class='absolute inset-x-0 bottom-0 h-[3px] bg-teal-400/60 transition-all duration-300 ease-out group-hover:h-full -z-10 rounded-sm opacity-70 group-hover:opacity-100'></span><span class='relative font-medium'>Cisco iGen</span></span> community and Encrypt Edge"
    }
  ]
};

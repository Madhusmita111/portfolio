  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground flex flex-col items-center selection:bg-accent selection:text-white overflow-x-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <svg className="absolute inset-0 w-full h-[200vh] opacity-[0.08] pointer-events-none text-foreground mask-[linear-gradient(to_bottom,black_85%,transparent)]" xmlns="http://www.w3.org/2000/svg">
